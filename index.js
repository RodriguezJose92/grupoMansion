...
async function serverData({
  ...
  function createBtns({ father, sku, idCompany, link3D, color, zBtns, zModal, ButtonsY }) {
    ...
    containerPrincipalBtns.innerHTML = `
      ...
      <img src="https://cdn.jsdelivr.net/gh/RodriguezJose92/grupoMansion@latest/assets/btn3D.webp" alt="Boton Mudi para activar 3D" class="btnMudi3D" id="btnMudi3D" sku=${sku} title="Haz click para tener una experiencia 3D">
      <img src="https://cdn.jsdelivr.net/gh/RodriguezJose92/grupoMansion@latest/assets/btnAR.webp" alt="Boton Mudi para activar AR" class="btnMudiAR" id="btnMudiAR" sku=${sku} title="Haz click para tener una experiencia de realidad aumentada">`;
